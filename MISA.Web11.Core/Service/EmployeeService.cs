...
namespace MISA.Web11.Core.Service
{
    public class EmployeeService:BaseService<Employee>, IEmployeeService
    {
        ...
        //Check trùng lặp
        public void ValidateDuplicate(Employee employee)
        {
        ...
        public void ValidateObject(Employee employee)
        {
            ...
            var phoneNumberVNProps = employee.GetType().GetProperties().Where(prop => Attribute.IsDefined(prop, typeof(PhoneNumber)));
        ...
        public Stream ExportExcel()
        {
           ...
           // ExcelPackage.LicenseContext = LicenseContext.Commercial;
            ...
            //tên bảng
            var workSheet = package.Workbook.Worksheets.Add(Properties.Resources.Excel_File_Name);
            ...
            using (var range = workSheet.Cells["A1:I1"])
            {
                ...
                range.Value = Properties.Resources.Excel_File_Name; //set giá trị
            ...
            for (int i = 0; i < data.Count(); i++)
            {
                ...
                workSheet.Cells[i + 4, 6].Value = data[i].Position;
                workSheet.Cells[i + 4, 7].Value = data[i].UnitName;
                workSheet.Cells[i + 4, 8].Value = data[i].BankNumber;
